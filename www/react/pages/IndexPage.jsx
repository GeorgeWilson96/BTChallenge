...
var IndexPage = React.createClass({
  render:function(){
    return(<div id="IndexPage">
      <a onClick={()=>{this.props.router.goto("/datetime");}}><button className = "ui button fluid homeButton">Book Seat</button></a>
      <a onClick={()=>{this.props.router.goto("/datetime");}}><button className = "ui button fluid homeButton">Book Group Space</button></a>
